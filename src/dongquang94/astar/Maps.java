...
public class Maps extends JFrame implements MouseListener, MouseMotionListener, ActionListener, ChangeListener {
    ...
    public Maps(int w, int h) {
        width = (w - 360) / 20; // 50
        height = (h - 100) / 20; // 33
        setTitle("Tìm đường đi cho robot");
        ...
        xx = new JLabel("Tọa độ con trỏ hiện tại:");
        yy = new JLabel("( x,  y)");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (btnDeleteMaps == ae.getSource()) {
            ...
            Astar.open = new ArrayList<Matrix>();
            Astar.close = new ArrayList<Matrix>();
            Astar.father = new ArrayList<List<Matrix>>();
        }
